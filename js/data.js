let list = [
    ...
    },
    {
        ...
        ans: [
            ...
            {
                ans:'2. 친한 사람들을 데려온다', score:[3,5,16,13,6,4,7,8,9,14,17,19,20]
            },
            {
                ans:'3. 미래에 도움이 될말한 사람을 데려온다', score:[1,12,15,2,18]
            }
        ]
    },
    {
    ...
    },
    {
        ...
        ans: [
            ...
            {
                ans:'2. 주변에 관심을 많이 가진다', score:[3,4,5,8,11,2,10,14,15,16,17,19,20]
            },
            {
                ans:'3. 다른일이 하고 싶어진다', score:[12,18]
            }
        ]
    },
    {
        ...
        ans: [
            {
                ans:'1. 도움을 요청한다', score:[1,2,16,15,14,3,6,13,18]
            },
            {
                ans:'2. 주변 사람을 데려온다', score:[7,11,5,8,9,19,20]
            },
            {
                ans:'3. 지나가거나 도망친다', score:[12,10,4,17]
            }
        ]
    },
    {
...
let info = [
    ...
    {
        name:"루피",
        dsc:"소심하고, 겁이 많으며 부끄러움을 잘 탑니다, 하지만 따뜻하고 친절하며 모범적입니다"
    },
    {
        name:"징징이",
        dsc:"남들에게 까칠하다고 소리를 듣지만, 내면은 소심하고 지식인처럼 행동하며 온순합니다"
    },
    {
        name:"잎싹",
        dsc:"발랄하고, 에너지가 매우 넘치는 캐릭터이지만 그만큼 자신과 가장 친한사람들을 잘 챙깁니다, 희생도 거스르지 않습니다"
    },
    {
        name:"흰둥이",
        dsc:"표현력이 매우 풍부하고, 정의롭지만 약간은 산만하기도 합니다"
    }
